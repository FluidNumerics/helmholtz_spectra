...
\authors{Joseph Schoonover\affil{1}, William K. Dewar\affil{2}, Andrew Poje\affil{3}, Nicolas Wienders, Garrett Byrd\affil{1}, Takaya Uchida\affil{4}}
...
\begin{figure}
    \centering
    \includegraphics{figures/mqgeometry_cornercut/kinetic_energy_over_time.svg}
    \includegraphics{figures/mqgeometry_dgirreg/kinetic_energy_over_time.svg}
...
\begin{figure}
    \centering
    \includegraphics{figures/mqgeometry_cornercut/vort_518400.png} %% TODO: Update to svg
    \includegraphics{figures/mqgeometry_dgirreg/vort_518400.png} %% TODO: Update to svg
...
\begin{figure}
    \centering
    \includegraphics{figures/mqgeometry_cornercut/rotational_spectra.svg}
    \includegraphics{figures/mqgeometry_dgirreg/rotational_spectra.svg}
