...
print(f"Bottom drag coefficient: {bottom_drag_coef:.6e} s^-1")
...
ibm_dragfield = (ibm_dragfield - ibm_dragfield.min()) / (ibm_dragfield.max() - ibm_dragfield.min())*bottom_drag_coef
